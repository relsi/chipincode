...
'Finish project that achieved the goal': 'Finish project that achieved the goal',
'Finish project that did not obtain the goal': 'Finalizar projeto que não atingiu a meta\r\n',
'Finish project that obtain the goal': 'Finalizar projeto que atingiu a meta',
...
'No donation received yet! Be the first to donate.': 'No donation received yet! Be the first to donate.',
...
'SSC (social security card)': 'SSC (social security card)',
